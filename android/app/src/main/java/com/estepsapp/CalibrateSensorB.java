...
import bolts.Task;
public class CalibrateSensorB extends ReactContextBaseJavaModule implements ServiceConnection {
    ...
    CalibrateSensorB(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public void sendDataToRN(String accel, String gyro, String magne) {
        reactContext.getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class)
                .emit("calibrationDataB", createEventData(accel, gyro, magne));
    }
