...
public class BatteryLevelA extends ReactContextBaseJavaModule implements ServiceConnection {
    ...
    public BatteryLevelA(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public void sendDataToRN(double level, double voltage, String serialNumber) {
        reactContext.getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class)
                .emit("batteryLevelA", createEventData(level, voltage, serialNumber));
    }
