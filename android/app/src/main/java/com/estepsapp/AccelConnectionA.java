...
public class AccelConnectionA extends ReactContextBaseJavaModule implements ServiceConnection {
    ...
    AccelConnectionA(ReactApplicationContext reactContext) {
        super(reactContext);
        ...
        board.connectAsync().onSuccessTask(new Continuation<Void, Task<Void>>() {
            ...
            public Task<Void> then(Task<Void> task) throws Exception {
                ...
                accelerometer.configure()
                        .odr(25f)       // Set sampling frequency to 1Hz, or closest valid ODR
                        .commit();
    ...
    public void sendDataToRN(double x, double y, double z, String serialNumber, String timestamp) {
        reactContext.getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class)
                .emit("accelDataA", createEventData(x, y, z, serialNumber, timestamp));
    }
