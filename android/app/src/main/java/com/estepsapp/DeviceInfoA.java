...
public class DeviceInfoA extends ReactContextBaseJavaModule implements ServiceConnection {
    ...
    public DeviceInfoA(ReactApplicationContext reactContext) {
        super(reactContext);
...
// Create a MetaWear board object for the Bluetooth Device
    ...
    public void sendDataToRN(String serialNumber, String firmwareRevision, String hardwareRevision, String manufacturer, String modelNumber) {
        reactContext.getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class)
                .emit("DeviceInfoA", createEventData(serialNumber, firmwareRevision, hardwareRevision, manufacturer, modelNumber));
    }
