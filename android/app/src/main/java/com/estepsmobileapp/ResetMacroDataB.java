...
public class ResetMacroDataB extends ReactContextBaseJavaModule implements ServiceConnection {
    private final ReactApplicationContext reactContext;
    private BtleService.LocalBinder serviceBinder;
    private MetaWearBoard board;
    private  String device;

    ResetMacroDataB(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    @ReactMethod
    public void bindResetDataMacroService(String device) {
        this.device = device;
    ...
    public void sendDataToRN(String result) {
        reactContext.getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class)
                .emit("RestMacroDataBResult", result);
    }

    @NonNull
    @Override
    public String getName() {
        return "ResetMacroDataB";
    }
}
