...
public class GyroConnection extends ReactContextBaseJavaModule implements ServiceConnection {
    ...
    GyroConnection(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        ...
        retrieveBoard("EB:CA:67:69:1A:BC");
    }
    @ReactMethod
    public void bindGyroService() {
...
// Create a MetaWear board object for the Bluetooth Device
    ...
    private void emitGyroData(double x, double y, double z) {
        reactContext
                ...
                .emit("GyroData", String.format("%f/ %f/ %f", x, y, z));
    }
    @Override
